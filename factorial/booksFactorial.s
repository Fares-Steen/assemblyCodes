 # as booksFactorial.s --32 -o booksFactorial.o;ld -m elf_i386 booksFactorial.o -o booksFactorial;./booksFactorial;echo $?
...
cmpl $1, %eax # 8(%ebp) holds the first parameter
              # If the number is 1, that is our base
              # c ase, and we simply return (1 is
